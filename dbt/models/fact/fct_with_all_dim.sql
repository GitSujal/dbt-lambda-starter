...
with fct_and_dim as (
  select
    ...
    du.user_role,
    ds.series_name,
    dso.organization_name,
    dso.organization_shortname,
    dso.organization_email,
    dso.organization_sporttype,
    dd.division_name
  ...
  left join {{ ref('dim_series_organization') }} dso on ds.series_id = dso.series_id
